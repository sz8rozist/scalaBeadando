 ...
 */
case class Player(nev: String, id: String, hp: Int, pos: Position, baseStat: EntityStats, activeEffect: Map[Effect,Duration], capacity: Int, inventory: Chest, equipmentSlots: Int, equipmentInventory: Chest) extends Entity{
  /**
